...
def RamificacionAcotacion(problem):
    return graph_search(problem, orderListByCost())         # orderListByCost
...
def RamificacionAcotacionHeuristica(problem):
    """Search the cheapest movement from current node to the next node."""
    return graph_search(problem, orderListByCostAndHeuristic(problem))  # orderListByCostAndHeuristic
